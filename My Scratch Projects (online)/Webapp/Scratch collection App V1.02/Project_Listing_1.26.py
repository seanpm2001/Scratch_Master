...
if (userSel == 2):
	...
	while (loopWallaWalla == 1):
		...
		projectB3LikeCount = int(0)
		projectB3FavCount = int(0)
		# project B4 statistics
		projectB4ViewCount = int(1)
		projectB4LikeCount = int(0)
		projectB4FavCount = int(0)
		# project B5 statistics
		projectB5ViewCount = int(1)
		projectB5LikeCount = int(0)
		projectB5FavCount = int(0)
		# project B6 statistics
		projectB6ViewCount = int(1)
		projectB6LikeCount = int(0)
		projectB6FavCount = int(0)
		# project B7 statistics
		projectB7ViewCount = int(1)
		projectB7LikeCount = int(0)
		projectB7FavCount = int(0)
		search1 = str(input("Search a project before you leave? type a number 1 through 1336 or type 'about' \nOther commands:\t\tPattern"))
		if (search1 == "1"):
